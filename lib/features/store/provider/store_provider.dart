...
class StoreProvider extends ChangeNotifier {
  ...
  String? get businessUnitId {
    final id = _selectedRestaurant?.businessUnit.csBunitId; // Null check implicit
  ...
  void initializeStores(StoreModel data) {
    AppLogger.logInfo('$TAG: Initializing store data with ${data.restaurants.length} restaurants');
    _storeData = data;
    notifyListeners();
  }
  ...
  void selectRestaurant(RestaurantModel restaurant) {
    ...
    AppLogger.logInfo('$TAG: Updating businessUnitId to: ${restaurant.businessUnit.csBunitId}');
  ...
  bool validateBusinessUnit(String? csBunitId) {
    ...
    AppLogger.logInfo('$TAG: Validating businessUnitId - Current: $businessUnitId, Checking: $csBunitId, Valid: $isValid');
    return isValid;
  }
