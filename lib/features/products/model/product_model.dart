...
//         productioncenter: json['productioncenter']?.toString(),
//         preparationtime: json['preparationtime']?.toString(),
//         preorder: json['preorder']?.toString() ?? 'N',
//         shortDesc: json['short_desc']?.toString() ?? 'No description available',
//         veg: json['veg']?.toString() ?? 'Y',
//         unitprice: json['unitprice']?.toString() ?? '50',
//         listprice: json['listprice']?.toString() ?? '50',
//         imageUrl: json['imageUrl']?.toString(),
//         bestseller: json['bestseller']?.toString() ?? 'N',
...
//                   ingredientsData.map((i) => i?.toString() ?? '')
//               );
//             } else {
//               AppLogger.logWarning('$TAG: Ingredients is not a List: ${ingredientsData.runtimeType}');
//               return null;
...
//       AppLogger.logDebug('$TAG: Parsing tax categories');
//
//       // Check that json is actually a List
//       if (json is! List) {
//         AppLogger.logError('$TAG: Expected List for taxCategories but got ${json.runtimeType}');
//         return null;
//       }
...
//         taxRate: (json['taxRate'] is num)
//             ? json['taxRate'].toDouble()
//             : double.tryParse(json['taxRate']?.toString() ?? '0') ?? 0.0,
//         csTaxcategoryID: json['csTaxcategoryID']?.toString() ?? '',
//         parentTaxId: json['parentTaxId']?.toString(),
//       );
//     } catch (e) {
//       AppLogger.logError('$TAG: Error parsing TaxCategory: $e');
...
//         preorder: json['preorder'] ?? 'N',
//         shortDesc: json['short_desc'],
//         veg: json['veg'] ?? 'N',
//         unitprice: json['unitprice'] ?? '0',
//         listprice: json['listprice'] ?? '0',
//         imageUrl: json['imageUrl'],
//         bestseller: json['bestseller'] ?? 'N',
//         available: json['available'],
//         availableFrom: json['available_from'],
//         availableTo: json['available_to'],
//         nextAvailableFrom: json['next_available_from'],
//         nextAvailableTo: json['next_available_to'],
//         addOnGroups: _parseAddOnGroups(json['add_on_group']),
//         attributeGroups: _parseAttributeGroups(json['attributeGroup']),
//         ingredients: json['ingredients'] != null
...
//     try {
//       AppLogger.logDebug('$TAG: Parsing tax categories');
//       return List<TaxCategory>.from((json as List)
//           .map((e) => TaxCategory.fromJson(e as Map<String, dynamic>)));
//     } catch (e) {
//       AppLogger.logError('$TAG: Error parsing tax categories: $e');
//       return null;
//     }
...
//             ? json['taxRate'].toDouble()
//             : double.tryParse(json['taxRate']?.toString() ?? '0') ?? 0.0,
//         csTaxcategoryID: json['csTaxcategoryID'] ?? '',
