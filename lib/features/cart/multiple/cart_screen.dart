...
import '../../ordering/order_shared_common/payment_processor.dart';
import '../../ordering/order_shared_common/payment_screen.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          Text(
            'You can cancel your order_shared_common within 30 seconds of order_shared_common placement to get a 100% refund. To avoid food wastage, you cannot cancel after 30 seconds.',
