// lib/features/order_shared_common/provider/kitchen_order_state.dart
...
class KitchenOrderState extends ChangeNotifier {
  ...
  void setOrder(KitchenOrder order) {
    ...
    AppLogger.logInfo('Kitchen order_shared_common updated', tag: TAG);
    notifyListeners();
  }

  void updateOrderStatus(String documentNo, String status) {
    _orderStatuses[documentNo] = status;
    AppLogger.logInfo('Status updated for order_shared_common $documentNo: $status',
        tag: TAG);
    notifyListeners();
  }
