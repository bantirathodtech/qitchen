...
class KitchenOrderViewModel extends ChangeNotifier {
  ...
  Future<bool> createRedisOrder({
    ...
    try {
      // Step 1: Log the start of the kitchen order creation process
      ...
      // Step 5: Call the repository to create the order in Redis
      ...
      AppLogger.logInfo('Kitchen order created successfully: ${response.message}', tag: TAG);
      return true;
    } catch (e) {
