...
// Model for individual order_shared_common details
class OrderHistory {
  final String orderId; // Unique identifier for the order_shared_common
  final String documentNo; // Display order_shared_common number (e.g., SO/WMS557)
  final String orderDate; // Date of order_shared_common placement
  ...
  final double totalAmount; // Total order_shared_common amount
  final List<OrderLineItem> items; // List of items in the order_shared_common
...
// Model for items within an order_shared_common
class OrderLineItem {
